...
## Детали
Для примера будет описан код робота правой руки `dr12[3]` :point_right: (см. файл репозитория *code/right_hand.py*). Он должен ехать по правым стенам лабиринта, ориентируясь на свой правый датчик `Proximity_sensor[2]` (выделен синим цветом):
